LANSA.addComponent({id:"XCONNEC03",nm:"xConnectorEmail",ot:"ww",tp:"Widget",de:"Send email",tl:14000101,cl:14020008},function(l,oI,u){var fF=function(wP){wP.fireEmailSendCompleted=function(pStatus,pError){var eP=l.ePs();eP.aE("STATUS",pStatus);eP.aS("ERROR",pError);l.fE(this,"EMAILSENDCOMPLETED",eP);};};var fW=
