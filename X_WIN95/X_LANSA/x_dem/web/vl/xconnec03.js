LANSA.addComponent({id:"XCONNEC03",nm:"xConnectorEmail",ot:"ww",tp:"Widget",pt:"ap",de:"Send email",tl:14000101,cl:15000003},function(l,oI,u){var fF=function(wP){wP.fireEmailSendCompleted=function(pStatus,pError){var eP=l.ePs();eP.aE("STATUS",pStatus);eP.aS("ERROR",pError);l.fE(this,"EMAILSENDCOMPLETED",eP);};};var fW=
