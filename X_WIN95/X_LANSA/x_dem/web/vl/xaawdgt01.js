...
try
{
if ( (localStorage["XGOOGLEMAP_API_KEY"]) && (localStorage["XGOOGLEMAP_API_KEY"].length  > 30) && (localStorage["XGOOGLEMAP_API_KEY"]  != "YOUR_KEY_HERE"))
{
...
{
var
newKey = prompt( "Google Developer API Key Required. Visit https://developers.google.com/maps/documentation/javascript/get-api-key to get a key.", apiKey );
if ((newKey) && ( newKey.length > 30) && ( newKey !== "YOUR_KEY_HERE"))
{
apiKey = newKey;
}
try
