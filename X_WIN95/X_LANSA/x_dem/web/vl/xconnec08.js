LANSA.addComponent({id:"XCONNEC08",nm:"xConnectorCommandCall",ot:"ww",tp:"Widget",de:"Call a command",tl:14000101,cl:14020008},function(l,oI,u){var fF=function(wP){wP.fireCommandCallCompleted=function(pStatus,pError){var eP=l.ePs();eP.aE("STATUS",pStatus);eP.aS("ERROR",pError);l.fE(this,"COMMANDCALLCOMPLETED",eP);};};var fW=
