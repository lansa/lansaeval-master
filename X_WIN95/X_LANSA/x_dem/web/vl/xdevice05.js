LANSA.addComponent({id:"XDEVICE05",nm:"xDeviceFileWrite",ot:"ww",tp:"Widget",de:"Write to a local file",tl:14000101,cl:14020003},function(l,oI,u){var fF=function(wP){wP.fireCompleted=function(pStatus,pMessage){var eP=l.ePs();eP.aE("STATUS",pStatus);eP.aS("MESSAGE",pMessage);l.fE(this,"COMPLETED",eP);};};var fW=
